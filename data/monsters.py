...
small_monsters = [
    'Altaroth', 'Anteka', 'Apceros', 'Aptonoth', 'Barnos', 'Blango', 'Boaboa', 'Bnahabra', 'Bullfango', 
...
type_amphibian = [
    'Tetsucabra', 'Berserk Tetsucabra', 'Drilltusk Tetsucabra', 'Zamtrios', 'Tigerstripe Zamtrios', 'Zamite']

type_bird_wyvern = [
    'Gargwa', 'Gendrome', 'Genprey', 'Giadrome', 'Giaprey', 'Great Jaggi', 'Great Maccao', 'Gypceros', 'Purple Gypceros', 
...
type_fanged_beast = [
    'Arzuros', 'Redhelm Arzuros', 'Blango', 'Blangonga', 'Bullfango', 'Bulldrome', 'Conga', 'Congalala', 'Emerald Congalala', 
    'Gammoth', 'Elderfrost Gammoth', 'Kecha Wacha', 'Ash Kecha Wacha', 'Lagombi', 'Snowbaron Lagombi', 'Rajang', 'Furious Rajang', 'Volvidon']

type_fanged_wyvern = [
    'Dodogama', 'Girros', 'Great Girros', 'Great Jagras', 'Jagras', 'Odogaron', 'Ebony Odogaron', 'Shamos', 'Tobi-Kadachi', 
...
type_herbivore = [
    'Anteka', 'Apceros', 'Aptonoth', 'Gastodon', 'Kelbi', 'Kelbi (female)', 'Kelbi (male)', 'Kestodon', 'Kestodon (female)', 
    'Kestodon (male)', 'Larinoth', 'Mosswine', 'Moofah', 'Popo', 'Rhenoplos', 'Slagtoth']

type_leviathan = [
    'Agnaktor', 'Lagiacrus', 'Ludroth', 'Mizutsune', 'Soulseer Mizutsune', 'Nibelsnarf', 'Royal Ludroth', 'Uroktor']
...
type_elder_dragon = [
    'Alatreon', 'Amatsu', 'Behemoth', 'Chameleos', "Dah'ren Mohran", 'Dalamadur', 'Shah Dalamadur', 'Fatalis', 'Crimson Fatalis', 
...
var_rarespecies = [
    'Silver Rathalos', 'Gold Rathian', 'Molten Tigrex']

var_subspecies = [
    'Fulgur Anjanath', 'Ruby Basarios', 'Emerald Congalala', 'Plum Daimyo Hermitaur', 'Shah Dalamadur', 'Black Diablos', 'Acidic Glavenus', 
    'Black Gravios', 'Purple Gypceros', 'Ash Kecha Wacha', 'Red Khezu', 'Oroshi Kirin', 'White Monoblos', 'Tidal Najarala', 
    'Shrouded Nerscylla', 'Ebony Odogaron', 'Nightshade Paolumu', 'Coral Pukei-Pukei', 'Azure Rathalos', 'Pink Rathian', 'Desert Seltas', 
    'Desert Seltas Queen', 'Berserk Tetsucabra', 'Brute Tigrex', 'Viper Tobi-Kadachi', 'Blue Yian Kut-Ku', 'Tigerstripe Zamtrios', 'Stygian Zinogre']

var_variant = [
    'Frostfang Barioth', 'Seething Bazelgeuse', 'Raging Brachydios', 'Savage Deviljho', 'Chaotic Gore Magala', 'Shrieking Legiana', 'Ruiner Nergigante', 
    'Furious Rajang', 'Blackveil Vaal Hazak', 'Scarred Yian Garuga']

monster_variations = {
    'Deviant': var_deviant, 'Rare Species': var_rarespecies, 'Subspecies': var_subspecies, 'Variant': var_variant}


# Function for finding the monster variation
